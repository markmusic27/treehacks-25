"""
Configuration constants for the Maestro air instrument system.
"""
...
# MediaPipe model
# ---------------------------------------------------------------------------
# Project root (parent of src/) — model and assets live at root
_ROOT = Path(__file__).resolve().parent.parent
MODEL_PATH = str(_ROOT / "hand_landmarker.task")
...
import os  # noqa: E402
GX10_URL = os.environ.get("GX10_URL", "http://10.34.183.144:8001")
...
# FluidSynth
# ---------------------------------------------------------------------------
SOUNDFONT_PATH = str(_ROOT / "soundfont.sf2")
FLUIDSYNTH_GAIN = 0.8
